...
export default function AdminNav() {
    ...
    return (
        <>
            {/* Mobile Header */}
            <div className="md:hidden fixed top-0 left-0 right-0 bg-neutral-900/95 backdrop-blur-xl border-b border-neutral-800 shadow-lg z-50">
            ...
            <aside
                className={`
          fixed top-0 left-0 h-full w-64 bg-neutral-900/95 backdrop-blur-xl border-r border-neutral-800 shadow-2xl md:shadow-none z-50
            ...
            >
                <div className="flex flex-col h-full">
                        ...
                        <div className="space-y-1.5">
                            ...
                            {isAdmin && (
                                <Link to="/admin/dashboard" onClick={() => setIsMobileMenuOpen(false)}
                                    className={`flex items-center space-x-3 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all ${isActive('/admin/dashboard') ? 'bg-neutral-800 text-warning-400 font-bold shadow-inner' : 'text-neutral-400 hover:bg-neutral-800/60 hover:text-white'}`}>
                            ...
                            {(isAdmin || isQA) && (
                                <div className="space-y-1">
                                    <button 
                                        ...
                                        className="w-full flex items-center justify-between px-4 py-2.5 rounded-xl text-sm font-semibold text-neutral-300 hover:bg-neutral-800/60 hover:text-white transition-all focus:outline-none"
                                    >
                                        ...
                                        <div className="mt-1 ml-4 pl-3 border-l border-neutral-800 space-y-1">
                                            {isAdmin && (
                                                <Link to="/admin/calls" onClick={() => setIsMobileMenuOpen(false)}
                                                    className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/calls') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                    <span>Calls Completed</span>
                                                </Link>
                                            )}
                                            {isAdmin && (
                                                <Link to="/admin/topics" onClick={() => setIsMobileMenuOpen(false)}
                                                    className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${location.pathname.startsWith('/admin/topics') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                    <span>Topic</span>
                                                </Link>
                                            )}
                                            <Link to="/admin/qa" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/qa') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>Call QA Review</span>
                                            </Link>
                                            {isAdmin && (
                                                <Link to="/admin/languages" onClick={() => setIsMobileMenuOpen(false)}
                                                    className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/languages') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                    <span>Call Languages</span>
                                                </Link>
                                            )}
                                            {isAdmin && (
                                                <Link to="/admin/call-apps" onClick={() => setIsMobileMenuOpen(false)}
                                                    className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/call-apps') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                    <span>Call Apps</span>
                                                </Link>
                                            )}
                                        </div>
                            ...
                            {(isAdmin || isQA) && (
                                <div className="space-y-1">
                                    ...
                                    {openMenus.scriptedCalls && (
                                        <div className="mt-1 ml-4 pl-3 border-l border-neutral-800 space-y-1 animate-fade-in">
                                            <Link to="/admin/scripted-calls-review" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/scripted-calls-review') || isActive('/admin/scripted-qa') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>Scripted Calls Review</span>
                                            </Link>
                                            <Link to="/admin/scripted-topics" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${location.pathname.startsWith('/admin/scripted-topics') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>Scripted Call Topics</span>
                                            </Link>
                                            <Link to="/admin/scripted-languages" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/scripted-languages') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>Scripted Call Languages</span>
                                            </Link>
                                            <Link to="/admin/scripted-call-apps" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/scripted-call-apps') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                    ...
                                    {openMenus.transcription && (
                                        <div className="mt-1 ml-4 pl-3 border-l border-neutral-800 space-y-1">
                                            <Link to="/admin/segmentation" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/segmentation') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>Segmentation</span>
                                            </Link>
                                            <Link to="/admin/transcription" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/transcription') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>Transcription</span>
                                            </Link>
                                        </div>
                                    )}
                                    ...
                                    {openMenus.users && (
                                        <div className="mt-1 ml-4 pl-3 border-l border-neutral-800 space-y-1 animate-fade-in">
                                            <Link to="/admin/users" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/users') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>Users</span>
                                            </Link>
                                            <Link to="/admin/payouts" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/payouts') && !location.pathname.startsWith('/admin/payouts/finances') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>Payouts</span>
                                            </Link>
                                            <Link to="/admin/finances" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/finances') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>Finances</span>
                                            </Link>
                                            <Link to="/admin/pan-verification" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/pan-verification') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>PAN Verification</span>
                                            </Link>
                                            <Link to="/admin/agreements" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/agreements') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span>Agreements</span>
                                            </Link>
                                            <Link to="/admin/vendors" onClick={() => setIsMobileMenuOpen(false)}
                                                className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/vendors') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                <span className="flex items-center gap-1.5">
                                        ...
                                        <div className="mt-1 ml-4 pl-3 border-l border-neutral-800 space-y-1 animate-fade-in">
                                            ...
                                            {isAdmin && (
                                                <Link to="/admin/language-apps" onClick={() => setIsMobileMenuOpen(false)}
                                                    className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/language-apps') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                            ...
                                            {isAdmin && (
                                                <Link to="/admin/companies" onClick={() => setIsMobileMenuOpen(false)}
                                                    className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/companies') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                                                    <span>Company Phrase Configs</span>
                                                </Link>
                                            )}
                                            {isAdmin && (
                                                <Link to="/admin/phrases/downloads" onClick={() => setIsMobileMenuOpen(false)}
                                                    className={`flex items-center px-3 py-2 rounded-lg text-xs font-semibold transition-all ${isActive('/admin/phrases/downloads') ? 'bg-neutral-800 text-warning-400 font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/40'}`}>
                            ...
                            {(isQA && !isAdmin) && (
                                <Link to="/admin/qa-payments" onClick={() => setIsMobileMenuOpen(false)}
                                    className={`flex items-center space-x-3 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all ${isActive('/admin/qa-payments') ? 'bg-neutral-800 text-warning-400 font-bold shadow-inner' : 'text-neutral-400 hover:bg-neutral-800/60 hover:text-white'}`}>
                            ...
                            {(isQA && !isAdmin) && (
                                <Link to="/admin/qa-flags" onClick={() => setIsMobileMenuOpen(false)}
                                    className={`flex items-center space-x-3 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all ${isActive('/admin/qa-flags') ? 'bg-neutral-800 text-warning-400 font-bold shadow-inner' : 'text-neutral-400 hover:bg-neutral-800/60 hover:text-white'}`}>
                            ...
                            {isAdmin && (
                                <Link to="/admin/ambiguity" onClick={() => setIsMobileMenuOpen(false)}
                                    className={`flex items-center space-x-3 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all ${isActive('/admin/ambiguity') ? 'bg-neutral-800 text-warning-400 font-bold shadow-inner' : 'text-neutral-400 hover:bg-neutral-800/60 hover:text-white'}`}>
                            ...
                            {isQA && (
                                <div className="mt-3 p-3 bg-neutral-950/80 border border-neutral-800 rounded-xl space-y-2 shadow-inner">
                            ...
                            {isAdmin && (
                                <Link to="/admin/media" onClick={() => setIsMobileMenuOpen(false)}
                                    className={`flex items-center space-x-3 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all ${isActive('/admin/media') ? 'bg-neutral-800 text-warning-400 font-bold shadow-inner' : 'text-neutral-400 hover:bg-neutral-800/60 hover:text-white'}`}>
                    ...
                    <div className="p-4 border-t border-neutral-800 space-y-3">
                        <div className="rounded-2xl border border-neutral-800 bg-neutral-950/80 p-3.5 shadow-inner">
                            <div className="flex items-center space-x-3">
                            ...
                            {isQA && qaLanguage && (
                                <div className="mt-3 rounded-xl border border-cyan-500/30 bg-cyan-500/10 px-3 py-2 text-xs">
                        ...
                        <button
                            onClick={logout}
                            className="w-full flex items-center justify-center space-x-2 px-4 py-2.5 bg-neutral-800 hover:bg-neutral-700/80 border border-neutral-700/60 text-neutral-300 hover:text-white rounded-xl text-sm font-semibold transition-all"
                        >
