                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        {filteredLanguages.map(lang => (
                            <Link
                                ...
                                className="relative overflow-hidden group p-6 rounded-3xl bg-gradient-to-br from-neutral-900 via-neutral-900/95 to-indigo-950/20 hover:to-indigo-950/40 border border-neutral-800 hover:border-indigo-500/60 transition-all duration-300 shadow-xl flex flex-col justify-between"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center justify-between gap-2 mb-3">
                                        <div className="flex items-center gap-2.5">
                                            <div className="w-10 h-10 rounded-xl bg-indigo-950/60 border border-indigo-800/50 flex items-center justify-center text-indigo-400 group-hover:scale-105 transition-transform shadow-md">
                                ...
                                <div className="pt-3 border-t border-neutral-800/80 flex items-center justify-between text-xs font-bold text-indigo-400 group-hover:text-indigo-300 relative z-10">
                                    <span>Manage Scripted Topics</span>
