...
export default function AdminTopicsSubprojects() {
            ...
            <div className="flex-1 md:ml-64 p-6 min-w-0">
                ...
                <div className="flex flex-col gap-3 pb-6 border-b border-neutral-800">
                    <div className="flex items-center gap-2 text-xs font-semibold text-neutral-400">
                        ...
                        <span>/</span>
                        <span className="text-primary-400">Subprojects</span>
                    </div>

                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <div className="flex items-center gap-2">
                                <Link to="/admin/topics" className="p-1.5 rounded-lg bg-neutral-800 hover:bg-neutral-700 text-neutral-400 hover:text-white transition-colors">
                            ...
                            <p className="text-sm text-neutral-400 mt-1">
                                Choose a subproject to view and manage its topics, subtopics, and call quotas.
                            </p>
                        </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mt-6 mb-6">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            ...
                            placeholder={`Search ${currentBaseLanguage} subprojects...`}
                            className="w-full pl-9 pr-4 py-2 bg-neutral-800/80 border border-neutral-700/80 rounded-xl text-xs text-white placeholder-neutral-500 focus:outline-none focus:border-primary-500 transition-colors"
                        />
                    </div>
                ...
                {loading ? (
                    <div className="py-24 flex flex-col items-center justify-center gap-3 text-neutral-400">
                        ...
                        <span className="text-xs">Loading subprojects...</span>
                    </div>
                    ...
                    <div className="py-16 text-center text-neutral-400 bg-neutral-800/30 rounded-2xl border border-neutral-800 p-8">
                        ...
                        <p className="text-sm font-semibold text-neutral-300">No Subprojects Found for {currentBaseLanguage}</p>
                        <p className="text-xs text-neutral-500 mt-1">Configure subprojects under Language Management in the sidebar.</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {filteredSubprojects.map(sub => (
                            <Link
                                key={sub._id}
                                to={`/admin/topics/${encodeURIComponent(langCode)}/subprojects/${encodeURIComponent(sub.code)}/topics`}
                            ...
                            >
                                        ...
                                        <div className="flex items-center gap-2.5">
                                            ...
                                            <div>
                                                <h3 className="font-bold text-base text-white group-hover:text-primary-300 transition-colors">
                                                    {sub.projectName || sub.name || "Default Project"}
                                                </h3>
                                ...
                                <div className="pt-2 flex items-center justify-between text-xs font-bold text-primary-400 group-hover:text-primary-300">
                                    <span>Manage Topics & Subtopics →</span>
