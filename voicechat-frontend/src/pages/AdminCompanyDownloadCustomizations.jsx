      ...
      <main className="flex-1 md:ml-64 p-8 max-w-4xl mx-auto text-neutral-900 dark:text-neutral-50">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-neutral-500 dark:text-neutral-400">
                Select metadata fields downloaded in the ZIP package for <span className="font-semibold text-primary-600 dark:text-primary-400">{company.projectName || company.name}</span>.
              </p>
            </div>
            {message && (
        ...
        <div className="grid gap-8 grid-cols-1 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="card">
              <h2 className="text-lg font-bold mb-4">Select Downloaded Tag Keys</h2>
