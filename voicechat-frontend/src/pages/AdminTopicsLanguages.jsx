...
export default function AdminTopicsLanguages() {
    ...
    async function loadData() {
        ...
        try {
            ...
            // Calculate topics count per base language
            ...
            <div className="flex-1 md:ml-64 p-6 min-w-0">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-neutral-800">
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <h1 className="text-2xl font-bold tracking-tight text-white flex items-center gap-2">
                                ...
                                <span>Call Topics by Language</span>
                            </h1>
                            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-primary-900/60 text-primary-300 border border-primary-700/50">
                                Tier 1: Select Language
                            </span>
                        </div>
                        <p className="text-sm text-neutral-400">
                            Select a language to view its subprojects and manage topics, subtopics, and call quotas.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            onClick={loadData}
                            disabled={loading}
                            className="flex items-center gap-2 px-3 py-2 bg-neutral-800 hover:bg-neutral-700 border border-neutral-700 rounded-xl text-xs font-semibold text-neutral-300 hover:text-white transition-all shadow-sm"
                        >
                ...
                {loading ? (
                    <div className="py-24 flex flex-col items-center justify-center gap-3 text-neutral-400">
                        ...
                        <span className="text-xs">Loading call languages and topic quotas...</span>
                    </div>
                    ...
                    <div className="py-16 text-center text-neutral-400 bg-neutral-800/30 rounded-2xl border border-neutral-800">
                        ...
                        <p className="text-sm font-semibold text-neutral-300">No Languages Found</p>
                        <p className="text-xs text-neutral-500 mt-1">Try adjusting your search filter or add a new language in Call Languages.</p>
                    </div>
                ) : (
