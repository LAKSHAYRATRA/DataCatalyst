...
const languageSchema = new mongoose.Schema(
    {
        name: { type: String, required: true, trim: true },   // "Doctor-Patient Conversations (Hindi)" or "Hindi"
        projectName: { type: String, trim: true, default: "" }, // "Doctor-Patient Conversations"
        language: { type: String, trim: true, default: "" },    // "Hindi"
        code: { type: String, required: true, unique: true, trim: true, lowercase: true }, // "doctor-patient-conversations-hindi"
